...
# pdi_ceo_diagnosis documentation build
...
from pdi_ceo_diagnosis import __version__ as release

# -- Project information -----------------------------------------------------

project = "pdi_ceo_diagnosis"
author = "Kedro"
...
htmlhelp_basename = "pdi_ceo_diagnosisdoc"
...
latex_documents = [
    (
        master_doc,
        "pdi_ceo_diagnosis.tex",
        "pdi_ceo_diagnosis Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "pdi_ceo_diagnosis",
        "Project pdi_ceo_diagnosis codebase.",
        "Data-Science",
    )
]
